...
// Tue Jan 24 16:21:35 2017 by ROOT version 5.30/03
// from TTree W/Waveform digitizer raw data
// found on file: ../root/beam_00003310-0000.root
//////////////////////////////////////////////////////////

#ifndef checkthespill_h
#define checkthespill_h
...
class checkthespill : public TSelector {
public :
   ...
   checkthespill(TTree * /*tree*/ =0) { }
   virtual ~checkthespill() { }
   ...
   ClassDef(checkthespill,0);
};

#endif

#ifdef checkthespill_cxx
void checkthespill::Init(TTree *tree)
{

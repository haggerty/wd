...
Int_t emcpeak( TString filename, Int_t column = -1, Int_t adccut = 120, Int_t nbins = 100, Float_t minadc = 0.0, Float_t maxadc = 3000.0 )
{
  ...
  TString pdffilename = "emc3peak_basic_";

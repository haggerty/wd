...
Int_t emc3peak_row_or_column( TString filename, Int_t row = -1, Int_t column = -1, Int_t adccut = 30, Float_t minadc = 0.0, Float_t maxadc = 1200.0 )
{
